...
AutoCircle	     ProductZoom       autoCircle	autoCircle (any string is fine, *optional)
InnerZoom	     ProductZoom       iZoom		iZoom (any string is fine, *optional)
...
"figure" tags and add ng-show to the <img> tag as shown below: (You can delete the current text within the "figure" tags and replace it with the text below)

<figure>
	<img ng-show="LineItem.Product.Type=='VariableText' && LineItem.Variant" id="451_img_prod_lg" 
	class="product-image-large img-responsive" 
	ng-src="{{LineItem.Variant.PreviewUrl || LineItem.Variant.LargeImageUrl || LineItem.Product.LargeImageUrl}}" 
	imageonload />
